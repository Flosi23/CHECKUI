...
const SvgShareIos = (props: SVGProps<SVGSVGElement>) => (
  <svg xmlns="http://www.w3.org/2000/svg" overflow="visible" preserveAspectRatio="none" viewBox="0 0 95 120" {...props}>
    ...
    />
    <path
      d="M25.341 31.6a4.5 4.5 0 0 0 3.045-1.187l14.221-13.075v60.934a4.5 4.5 0 0 0 9 0V16.859l14.164 13.5a4.5 4.5 0 1 0 6.209-6.515L50.605 3.47a4.5 4.5 0 0 0-6.151-.055l-22.16 20.372a4.5 4.5 0 0 0 3.047 7.813"
      vectorEffect="non-scaling-stroke"
    />
  </svg>
);
